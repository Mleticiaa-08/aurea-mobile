...
const ReferenciasDark = () => {
  ...
  return (
    <div className="w-full bg-[#704943] min-h-screen pt-28"> 

      <div className="hidden lg:block">
        <div className="min-h-screen flex flex-col items-center px-4 pt-16 pb-16">
          
          <div className="w-full max-w-3xl text-center mb-8">
            <h1 className="text-4xl font-playfair font-bold text-[#B39889] mb-3">
              REFERÊNCIAS
            </h1>
            <p className="text-2xl font-poppins font-light italic text-[#B39889]">
...
export default ReferenciasDark;