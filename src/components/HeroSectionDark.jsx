    ...
    <div className="w-full pt-28 px-4 max-w-7xl mx-auto bg-[#61372F]">
      ...
      <div className="lg:hidden flex flex-col justify-center items-center pt-24 px-4">
        ...
        <div className="flex flex-row gap-4 justify-center mb-6">
          <div className="w-[132px] h-[151px] bg-[#DEC8BC] border-[1.8px] border-[#CDA6A2] p-2 flex flex-col rounded-lg">
        ...
        <div className="w-[273px] h-[230px] bg-[#DEC8BC] border-[1.8px] border-[#CDA6A2] p-4 flex flex-col items-center justify-between mb-6 rounded-lg">
          ...
          <Link to="/funcionamento">
            <button className="w-[98px] h-[18px] bg-[#DEC8BC] border-[1px] border-[#61372F] flex items-center justify-center rounded">
        ...
        <div className="flex flex-col gap-7 justify-center w-full max-w-[170px] mb-6">
          <div className="w-[170px] h-[155px] bg-[#DEC8BC] border-[1.8px] border-[#CDA6A2] p-3 flex flex-col rounded-lg">
          ...
          <div className="w-[170px] h-[160px] bg-[#DEC8BC] border-[1.8px] border-[#CDA6A2] p-3 flex flex-col rounded-lg">
        ...
        <p className="text-[9px] font-poppins text-[#61372F] text-center">@iisacost_</p>
        <p className="text-[15px] font-playfair text-[#61372F] text-center">Isabela Costa</p>
        <div className="w-[135.76px] h-[0.98px] bg-[#61372F] mb-4"></div>

        <img src={danielle} alt="Danielle" className="w-[122.47px] h-[132.91px] object-contain mb-1" />
        <p className="text-[9px] font-poppins text-[#61372F] text-center">@_dany.elle_</p>
        <p className="text-[15px] font-playfair text-[#61372F] text-center">Danielle Freitas</p>
        <div className="w-[135.76px] h-[0.98px] bg-[#61372F] mb-4"></div>

        <img src={leticia} alt="Leticia" className="w-[122.47px] h-[132.91px] object-contain mb-1" />
        <p className="text-[9px] font-poppins text-[#61372F] text-center">@lelealmeida__</p>
        <p className="text-[15px] font-playfair text-[#61372F] text-center">Letícia Moreira</p>
        <div className="w-[135.76px] h-[0.98px] bg-[#61372F] mb-4"></div>

        <img src={gabriela} alt="Gabriela" className="w-[122.47px] h-[132.91px] object-contain mb-1" />
        <p className="text-[9px] font-poppins text-[#61372F] text-center">@gabiheerculano_</p>
        <p className="text-[15px] font-playfair text-[#61372F] text-center">Gabriela Herculano</p>
        <div className="w-[135.76px] h-[0.98px] bg-[#61372F] mb-4"></div>
        ...
        <div className="flex flex-col items-start mb-4" style={{ width: '241px' }}>
          <p className="text-[12px] font-poppins font-light italic text-[#61372F] mb-1 ml-1">Nome</p>
          <input type="text" placeholder="Digite aqui..." className="w-[241px] h-[33px] bg-[#DEC8BC] border-2 border-[#61372F] pl-3 text-[12px] font-playfair text-[#61372F] placeholder-[#61372F] rounded" />
        </div>

        <div className="flex flex-col items-start mb-4" style={{ width: '241px' }}>
          <p className="text-[12px] font-poppins font-light italic text-[#61372F] mb-1 ml-1">E-mail</p>
          <input type="email" placeholder="Digite aqui..." className="w-[241px] h-[33px] bg-[#DEC8BC] border-2 border-[#61372F] pl-3 text-[12px] font-playfair text-[#61372F] placeholder-[#61372F] rounded" />
        </div>

        <div className="flex flex-col items-start mb-6" style={{ width: '241px' }}>
          <p className="text-[12px] font-poppins font-light italic text-[#61372F] mb-1 ml-1">Assunto</p>
