    ...
    <div className="min-h-screen bg-[#FAE6DD] flex flex-col items-center px-4 pt-24 pb-10 md:pt-32 md:pb-16">
      ...
      <div className="w-full max-w-4xl space-y-8 md:space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="w-full max-w-[160px] md:max-w-none mx-auto h-[210px] md:h-[240px] bg-[#DEC8BC] border-[1.8px] border-[#CDA6A2] p-3 flex flex-col" style={{ borderRadius: '8px' }}>
            <h4 className="text-[14px] md:text-[16px] font-bold text-[#61372F] text-center mb-1" style={{ fontFamily: "'Poppins', sans-serif" }}>1920S</h4>
            <h5 className="text-[12px] md:text-[14px] font-semibold text-[#61372F] text-center mb-2" style={{ fontFamily: "'Poppins', sans-serif" }}>
              A ERA DO SILÊNCIO<br />ESTRONDOSO
            </h5>
            <p className="text-[10px] md:text-[11px] font-light text-[#61372F] text-center" style={{ fontFamily: "'Poppins', sans-serif" }}>
          ...
          <div className="w-full max-w-[160px] md:max-w-none mx-auto h-[210px] md:h-[240px] bg-[#DEC8BC] border-[1.8px] border-[#CDA6A2] p-3 flex flex-col" style={{ borderRadius: '8px' }}>
            <h4 className="text-[14px] md:text-[16px] font-bold text-[#61372F] text-center mb-1" style={{ fontFamily: "'Poppins', sans-serif" }}>1980S</h4>
            <h5 className="text-[12px] md:text-[14px] font-semibold text-[#61372F] text-center mb-2" style={{ fontFamily: "'Poppins', sans-serif" }}>
          ...
          <div className="w-full max-w-[160px] md:max-w-none mx-auto h-[210px] md:h-[240px] bg-[#DEC8BC] border-[1.8px] border-[#CDA6A2] p-3 flex flex-col" style={{ borderRadius: '8px' }}>
            <h4 className="text-[14px] md:text-[16px] font-bold text-[#61372F] text-center mb-1" style={{ fontFamily: "'Poppins', sans-serif" }}>2000S</h4>
            <h5 className="text-[12px] md:text-[14px] font-semibold text-[#61372F] text-center mb-2" style={{ fontFamily: "'Poppins', sans-serif" }}>
              O BRILHO<br />DIGIT@L
            </h5>
            <p className="text-[10px] md:text-[11px] font-light text-[#61372F] text-center" style={{ fontFamily: "'Poppins', sans-serif" }}>
          ...
          <div className="w-full max-w-[160px] md:max-w-none mx-auto h-[210px] md:h-[240px] bg-[#DEC8BC] border-[1.8px] border-[#CDA6A2] p-3 flex flex-col md:mb-0 mb-8 mt-1" style={{ borderRadius: '8px' }}>
            <h4 className="text-[14px] md:text-[16px] font-bold text-[#61372F] text-center mb-1" style={{ fontFamily: "'Poppins', sans-serif" }}>FUTURO</h4>
            <h5 className="text-[12px] md:text-[14px] font-semibold text-[#61372F] text-center mb-2" style={{ fontFamily: "'Poppins', sans-serif" }}>
              A ERA DO<br />NÃO-ESTILO
            </h5>
            <p className="text-[10px] md:text-[11px] font-light text-[#61372F] text-center" style={{ fontFamily: "'Poppins', sans-serif" }}>
              No futuro, tudo se ajuda. Mas, quando ninguém mais era quem dava as destaca? Hora de planar o caos creativo no coração da partilaga.
            </p>
          </div>
        </div>
